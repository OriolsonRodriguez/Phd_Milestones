...
[Insert Advanced Information Research Skills (AIRS / IFN006) is underway, this course will end on july]
...
For these tensor high sparsity is expected because absence of evidence is recorded as missing, not as zero.
...
\[
  ...
  \end{pmatrix},
\]
this values are expanded to the five ordinal classes $\pi_{d,k}$ and reduced to the
...
Finally, I used Claude Code as a writing assistant for this document, to help with grammar, readability and latext document formatting. All research questions, 
